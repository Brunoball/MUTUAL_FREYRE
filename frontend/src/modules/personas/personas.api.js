...
export const getPersonaVinculosImpacto = (id, options) =>
  apiGet("personas/vinculos-impacto", { id }, options);
...
export const cambiarEstadoPersona = (
  id,
  activo,
  motivo = "",
  fechaBaja = null,
  confirmarVinculos = false,
) =>
  apiPatch(
    "personas/estado",
    {
      ...
      confirmar_vinculos: confirmarVinculos,
    },
    { query: { id } },
  );
