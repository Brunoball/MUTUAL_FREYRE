...
final class ConfiguracionRepository
{
    ...
    public function createUser(
        ...
        return IdentityConnection::transaction(static function (PDO $db) use (
            ...
            if ($beforeCommit !== null) {
                $beforeCommit($db, $accessId, $userId);
            }
    ...
    public function deleteAccess(int $accessId, ?callable $beforeCommit = null): void
    {
        IdentityConnection::transaction(static function (PDO $db) use ($accessId, $beforeCommit): void {
